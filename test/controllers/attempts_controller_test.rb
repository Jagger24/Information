...
class AttemptsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create attempt" do
    assert_difference('Attempt.count') do
      post attempts_url, params: { attempt: { content: @attempt.content, user_id: @attempt.user_id } }
    end
  ...
  test "should update attempt" do
    patch attempt_url(@attempt), params: { attempt: { content: @attempt.content, user_id: @attempt.user_id } }
